      ...
      {visibleResources.map((r: any, i: number) => {
        ...
        if (isLive) {
          return (
            ...
            >
              <Tooltip>
                <div style={{ fontFamily: "Inter, sans-serif", fontSize: 11, lineHeight: 1.5, minWidth: 160 }}>
        ...
        return (
          ...
          >
            <Tooltip>
              <div style={{ fontFamily: "Inter, sans-serif", fontSize: 11, lineHeight: 1.5, minWidth: 140 }}>
                <div style={{ fontWeight: 700, color, fontSize: 12 }}>{RESOURCE_LABELS[resType] || resType}</div>
          ...
          onEachFeature={(feature, layer) => {
            ...
            layer.bindPopup(
              L.popup({ className: "mw-popup" }).setContent(`
                <div style="font-family:Inter,sans-serif;font-size:12px;color:#fafafa;min-width:180px">
